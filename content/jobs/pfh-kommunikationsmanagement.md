...
* Recherche und Organisation von Veranstaltungsorten im ländlichen Raum
* Kommunikation organisatorischer Details an Teilnehmende
* Recherche und interne Aufbereitung von aktuellen Diskursen im Bereich der Energiepolitik und -technik sowie Open-Source-Hardware-Community
* Entwicklung einer Social Media Strategie
* Betreuung verschiedener Social Media Accounts (mit Fokus auf Bild und Text, du solltest allerdings einfache Videos schneiden können)
* Gemeinsame Konzeptionierung einer digitalen Plattform für offene Energietechnik

### Konkret fallen folgende Aufgaben im Projekt OpenEnergy an, die wir gemeinsam angehen: 
* Aufbau einer digitalen Plattform für offene Energietechnik
* Unterstützung bei der zielgruppengerechten Dokumentation von Open-Source-Hardware-Projekten
* Organisation von 8 Veranstaltungen im ländlichen Raum (Aufbauworkshops, Diskussion der Energiewende)
* Öffentlichkeitsarbeit zu den zivilgesellschaftlichen Potenzialen offener Energietechnik
